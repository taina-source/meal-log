...
type Overlay = { kind: 'meal'; type: MealType; date: string; entry?: MealEntry } | { kind: 'detail'; entry: MealEntry } | { kind: 'weight'; date: string; weight?: number } | { kind: 'copy'; date: string } | null;
