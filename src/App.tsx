...
type Overlay = { kind: 'health' } | { kind: 'chatgpt'; receipt: ImportReceipt; key: string } | { kind: 'meal'; type: MealType; date: string; entry?: MealEntry } | { kind: 'detail'; entry: MealEntry } | { kind: 'weight'; date: string } | { kind: 'copy'; date: string } | null;
