...
export function Home({ date, setDate, settings, onAdd, onHistory, onWeight, onHealth, onCopy, onSuggestions }: { date: string; setDate: (date: string) => void; settings: UserSettings; onAdd: (type?: MealType) => void; onHistory: (type: MealType) => void; onWeight: () => void; onHealth: () => void; onCopy: () => void; onSuggestions: () => void }) {
