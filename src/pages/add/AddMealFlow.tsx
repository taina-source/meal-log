...
type Route = { screen: 'hub' | 'favorites' | 'quick' | 'manual' | 'restaurants' | 'chatgpt' | 'chatgptPhoto'; restaurantId?: string } | { screen: 'foods'; food?: Food; grams?: number } | { screen: 'recipes'; recipe?: Recipe; fraction?: number } | { screen: 'sets'; set?: MealSet };
